...
- **Debugging & Mocking** — เพิ่ม **Pinned Mock Data** ใน Node Config Panel เพื่อ inject JSON เข้า context โดยไม่รัน live node; เพิ่ม **Debug Mode** ให้เลือก node เริ่มรันได้และ preload mock จาก upstream ที่ pin ไว้
